...
.method public constructor <init>(Landroid/content/Context;Lorg/chromium/ui/picker/DateTimePickerDialog$OnDateTimeSetListener;IIIIIZDD)V
    ...
    invoke-direct {p0, v0, v2}, Landroid/app/AlertDialog;-><init>(Landroid/content/Context;I)V
    ...
    iput-wide v2, p0, Lorg/chromium/ui/picker/DateTimePickerDialog;->mMinTimeMillis:J
    ...
    iput-wide v2, p0, Lorg/chromium/ui/picker/DateTimePickerDialog;->mMaxTimeMillis:J
    ...
    sget v3, Lorg/chromium/ui/R$string;->date_picker_dialog_set:I
    ...
    invoke-virtual {p0, v2, v3, p0}, Lorg/chromium/ui/picker/DateTimePickerDialog;->setButton(ILjava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)V
    ...
    invoke-virtual {p0, v3, v4, v2}, Lorg/chromium/ui/picker/DateTimePickerDialog;->setButton(ILjava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)V

    .line 74
    const/4 v2, 0x0

    invoke-virtual {p0, v2}, Lorg/chromium/ui/picker/DateTimePickerDialog;->setIcon(I)V

    .line 75
    sget v2, Lorg/chromium/ui/R$string;->date_time_picker_dialog_title:I
    ...
    invoke-virtual {p0, v2}, Lorg/chromium/ui/picker/DateTimePickerDialog;->setTitle(Ljava/lang/CharSequence;)V
    ...
    sget v2, Lorg/chromium/ui/R$layout;->date_time_picker_dialog:I
    ...
    .line 81
    sget v2, Lorg/chromium/ui/R$id;->date_picker:I
    ...
    iput-object v2, p0, Lorg/chromium/ui/picker/DateTimePickerDialog;->mDatePicker:Landroid/widget/DatePicker;

    .line 82
    iget-object v2, p0, Lorg/chromium/ui/picker/DateTimePickerDialog;->mDatePicker:Landroid/widget/DatePicker;

    iget-wide v9, p0, Lorg/chromium/ui/picker/DateTimePickerDialog;->mMinTimeMillis:J

    iget-wide v11, p0, Lorg/chromium/ui/picker/DateTimePickerDialog;->mMaxTimeMillis:J
    ...
    invoke-static/range {v2 .. v12}, Lorg/chromium/ui/picker/DateDialogNormalizer;->normalize(Landroid/widget/DatePicker;Landroid/widget/DatePicker$OnDateChangedListener;IIIIIJJ)V

    .line 85
    sget v2, Lorg/chromium/ui/R$id;->time_picker:I
    ...
    iput-object v2, p0, Lorg/chromium/ui/picker/DateTimePickerDialog;->mTimePicker:Landroid/widget/TimePicker;
    ...
    invoke-virtual {p0, v2, v3, v4}, Lorg/chromium/ui/picker/DateTimePickerDialog;->onTimeChanged(Landroid/widget/TimePicker;II)V
...
.method public onTimeChanged(Landroid/widget/TimePicker;II)V
    ...
    iget-wide v3, p0, Lorg/chromium/ui/picker/DateTimePickerDialog;->mMinTimeMillis:J
    ...
    .line 126
    iget-wide v1, p0, Lorg/chromium/ui/picker/DateTimePickerDialog;->mMinTimeMillis:J
    ...
    iget-wide v3, p0, Lorg/chromium/ui/picker/DateTimePickerDialog;->mMaxTimeMillis:J
    ...
    .line 128
    iget-wide v1, p0, Lorg/chromium/ui/picker/DateTimePickerDialog;->mMaxTimeMillis:J
