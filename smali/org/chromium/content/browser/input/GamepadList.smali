...
.method private grabGamepadData(J)V
    ...
    .line 297
    :try_start_0
    invoke-direct {p0, v3}, Lorg/chromium/content/browser/input/GamepadList;->getDevice(I)Lorg/chromium/content/browser/input/GamepadDevice;

    move-result-object v11

    .line 298
    .local v11, "device":Lorg/chromium/content/browser/input/GamepadDevice;
    if-eqz v11, :cond_0

    .line 299
    invoke-virtual {v11}, Lorg/chromium/content/browser/input/GamepadDevice;->updateButtonsAndAxesMapping()V

    .line 300
    invoke-virtual {v11}, Lorg/chromium/content/browser/input/GamepadDevice;->isStandardGamepad()Z

    move-result v4

    const/4 v5, 0x1

    invoke-virtual {v11}, Lorg/chromium/content/browser/input/GamepadDevice;->getName()Ljava/lang/String;

    move-result-object v6

    invoke-virtual {v11}, Lorg/chromium/content/browser/input/GamepadDevice;->getTimestamp()J

    move-result-wide v7

    invoke-virtual {v11}, Lorg/chromium/content/browser/input/GamepadDevice;->getAxes()[F

    move-result-object v9

    invoke-virtual {v11}, Lorg/chromium/content/browser/input/GamepadDevice;->getButtons()[F
    ...
    invoke-direct/range {v0 .. v10}, Lorg/chromium/content/browser/input/GamepadList;->nativeSetGamepadData(JIZZLjava/lang/String;J[F[F)V
    ...
    .line 307
    .end local v11    # "device":Lorg/chromium/content/browser/input/GamepadDevice;
    :catchall_0
    move-exception v0
