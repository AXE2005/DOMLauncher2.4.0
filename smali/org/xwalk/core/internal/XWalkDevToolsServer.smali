...
.method public setRemoteDebuggingEnabled(ZLorg/xwalk/core/internal/XWalkDevToolsServer$Security;)V
    ...
    .line 51
    .local v4, "allowDebugPermission":Z
    :goto_0
    ...
    .line 52
    .local v5, "allowSocketAccess":Z
    :goto_1
    iget-wide v1, p0, Lorg/xwalk/core/internal/XWalkDevToolsServer;->mNativeDevToolsServer:J

    move-object v0, p0

    move v3, p1

    invoke-direct/range {v0 .. v5}, Lorg/xwalk/core/internal/XWalkDevToolsServer;->nativeSetRemoteDebuggingEnabled(JZZZ)V

    .line 54
    return-void

    .end local v4    # "allowDebugPermission":Z
    .end local v5    # "allowSocketAccess":Z
    :cond_0
    move v4, v1
    ...
    .restart local v4    # "allowDebugPermission":Z
    :cond_1
    move v5, v1
