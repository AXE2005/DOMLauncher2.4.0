...
.method public getDefaultAccountNameAndType()[Ljava/lang/String;
    ...
    iget-object v1, v0, Lorg/xwalk/core/internal/extension/api/contacts/ContactUtils;->mResolver:Landroid/content/ContentResolver;
    ...
    instance-of v1, v11, Landroid/os/RemoteException;

    if-nez v1, :cond_0

    instance-of v1, v11, Landroid/content/OperationApplicationException;

    if-nez v1, :cond_0

    instance-of v1, v11, Ljava/lang/SecurityException;
    ...
    const-string v3, "getDefaultAccountNameAndType - Failed to apply batch: "
    ...
    .restart local v17    # "rawContactUri":Landroid/net/Uri;
    :cond_3
    const/4 v10, 0x0
    ...
    const-string v3, "getDefaultAccountNameAndType: "
...
.method public getLastUpdated(J)Ljava/lang/String;
    ...
    invoke-direct {p0, v3, v4}, Lorg/xwalk/core/internal/extension/api/contacts/ContactUtils;->timeConvertToJS(J)Ljava/lang/String;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
